...
// 	JsValue ret = *v;
// 	if(JS_VALUE_TYPE_INT == e->typ){
// 		v->u.intvalue -= 2 * v->u.intvalue;
// 	}
// 	if(JS_VALUE_TYPE_FLOAT == e->typ){
// 		v->u.floatvalue -= 2 * v->u.floatvalue;
// 	}
// 	if(JS_VALUE_TYPE_BOOL == e->typ){
